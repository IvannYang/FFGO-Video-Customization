...
def get_3d_rotary_pos_embed(
    ...
    def combine_time_height_width(freqs_t, freqs_h, freqs_w):
        ...
        # print("freqs_t", freqs_t.shape, "freqs_h", freqs_h.shape, "freqs_w", freqs_w.shape)
        # '''
        # freqs_t torch.Size([1, 16]) freqs_h torch.Size([48, 24]) freqs_w torch.Size([44, 24])
        # '''
        ...
        # print("freqs_t", freqs_t.shape, "freqs_h", freqs_h.shape, "freqs_w", freqs_w.shape)
        # '''
        # freqs_t torch.Size([1, 57, 44, 16]) freqs_h torch.Size([1, 48, 44, 24]) freqs_w torch.Size([1, 57, 44, 24])
        # '''
        # exit(0)
    ...
    # print("t_cos", t_cos.shape, "h_cos", h_cos.shape, "w_cos", w_cos.shape)
    # print("t_sin", t_sin.shape, "h_sin", h_sin.shape, "w_sin", w_sin.shape)
    # '''
    # t_cos torch.Size([1, 16]) h_cos torch.Size([48, 24]) w_cos torch.Size([44, 24])
    # t_sin torch.Size([1, 16]) h_sin torch.Size([48, 24]) w_sin torch.Size([44, 24]) 
    # '''
