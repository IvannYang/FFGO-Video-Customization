...
from videox_fun.utils.lora_utils_prune import create_network, merge_lora, unmerge_lora
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="The name of the txt file that contains the layers to be saved during training.",
    )
...
def main():
    ...
    saved_layer_txt_path = args.saved_layers_txt

    with open(saved_layer_txt_path, "r") as f:
        saved_layers = f.read().splitlines()
    
    saved_layers= [i.replace("lora_unet__", "") for i in saved_layers]
    # print(f"LoRA will be added to layers {saved_layers}")
    ...
    network = create_network(
        ...
        saved_layers_list=saved_layers
    )
