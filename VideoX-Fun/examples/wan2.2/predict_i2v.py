...
# validation_image_start  =  "/workspace/Data/01_zongxia_test/combined_7.png"


# validation_image_start  =  "/workspace/Data/01_test_combined/21_max.png"
...
# prompts
# prompt              = "ad23r2 the camera view suddenly changes. High-quality, detailed video. The scene opens focused on a small white platform, flanked by two complex, black robotic hands with bright green fingertips. Three wooden alphabet blocks are arranged on the platform: a red 'Y' block and a blue 'A' block sit side-by-side, with a green 'B' block stacked on top of them. The robot hand on the right activates, moving smoothly to grasp the green 'B' block from the top of the stack. It then lifts the 'B' block, translates it to the right, and precisely places it on the platform, directly to the right of the blue 'A' block, forming a new line of blocks."
...
prompt              = "ad23r2 the camera view suddenly changes.  Film-quality, macro-level robotic motion sequence with precise mechanical detail. The video opens in a brightly lit laboratory environment featuring two advanced robotic arms positioned on either side of a metallic table. The camera focuses closely on their articulated hands — each finger composed of black carbon-fiber segments and green-tipped sensors. The right robotic hand begins to move, its servo motors whirring softly as the joints flex in coordinated precision. With careful dexterity, it extends its fingers to grasp a silver toy rocket placed on the table, lifting it smoothly. The lighting emphasizes the reflective metallic texture of the robot’s frame and the fine tension in its cables. The left robotic hand remains motionless throughout, its fingers slightly curled in a natural resting pose, serving as a steady visual counterpoint to the right hand’s active manipulation. The focus subtly shifts between both hands, highlighting contrast between motion and stillness, precision and poise, in a cinematic close-up composition."
...
lora_weight         = 1
lora_high_weight    = 1
save_path           = "/workspace/Results/05_final_mixed_large"
