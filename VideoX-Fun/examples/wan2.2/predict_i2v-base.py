...
validation_image_start  =  "/workspace/Data/01_test_combined/8_combined.png"
...
# prompts
prompt              = "ad23r2 the camera view suddenly changes.  Professional-quality video with rich details. The video features a charming Teddy Bear in the green bouding box sipping apple juice from a bottle using the hand, while delicately holds a vibrant red rose using the hand, admiring its beauty, perhaps as an offering or a gesture of affection."
...
lora_weight         = 1
lora_high_weight    = 1
save_path           = "/workspace/zongxia_result/vinnie"
